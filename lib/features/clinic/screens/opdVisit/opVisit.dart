...
class OPDVisitScreen extends StatefulWidget {
  ...
  @override
  State<OPDVisitScreen> createState() => _OPDVisitScreenState();
}

class _OPDVisitScreenState extends State<OPDVisitScreen> {
  ...
  Future<List<Map<String, dynamic>>> fetchDashboardData({
    ...
    if (accessToken != null) {
      try {
        final response = await apiService.getOpdVisitData(
          accessToken,
          context,
          isMonthly: isMonthly,
          pDate: pDate,
        ...
        print('Error fetching OPD visit data: $e');
        return [];
      }
    } else {
                          ...
                          if (selectedPatientIndices.length == 1) {
                            ...
                            final selectedPatients =
                              ...
                              return {
                                ...patient,
                                'Screen Name':
                                    'opd visit', // <-- update this dynamically if needed
                              };
                            }).toList();
